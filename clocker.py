...
clocker_dir = os.path.join(home_dir, ".clocker")
temp_dir = tempfile.gettempdir()

DB_FILE = os.path.join(clocker_dir, 'timelog.db')
...
def visualize_time_distribution(start_date, end_date, category=None, open_image=True):
    ...
    try:
        ...
        fig_path = os.path.join(temp_dir, f"time_dist_{start_date}_{end_date}{'_' + category if category else ''}.png")
